...
public class ProfileServiceImpl implements ProfileService {
  ...
  @Override
  public ResponseResults editProfile(RequestEditProfileDto request, MultipartFile file) throws IllegalClassFormatException {
  ...
  private void checkPhoto(RequestEditProfileDto request, User user, MultipartFile file, Map<String, String> errors) throws IllegalClassFormatException {
